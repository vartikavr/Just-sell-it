...
const Others = () => {
    ...
    const getAllOthers = () => {
        ...
        axios.get(`${process.env.REACT_APP_URI}/categories/others`, {
            //allBooks: books
        }, axiosConfig)
            .then((res) => {
    ...
    return (
        <div className="others" id="allOthers">
            ...
            {!isPending &&
                <div className="dataDisplay">
                    ...
                    <div className="grid-display-products d-flex flex-row flex-wrap">
                        ...
                        {
                            !(allOthers.some(item => item.title.toLowerCase().includes(search.toLowerCase()))) ?
