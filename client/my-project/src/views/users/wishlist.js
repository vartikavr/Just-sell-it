...
const Wishlist = () => {
    ...
    const productInfo = () => {
        ...
        axios.get(`${process.env.REACT_APP_URI}/user/wishlist`, {
        }, axiosConfig)
            .then(async (res) => {
                setIsPending(true);
    ...
    const handleBookRemove = (event) => {
        ...
        axios.post(`${process.env.REACT_APP_URI}/user/wishlist/books/${id}/delete`, {
        }, axiosConfig)
            .then(async (res) => {
    ...
    const handleCycleRemove = (event) => {
        ...
        axios.post(`${process.env.REACT_APP_URI}/user/wishlist/cycles/${id}/delete`, {
        }, axiosConfig)
            .then(async (res) => {
                console.log("removed from wishlist");
                setIsDeleted(true);
    ...
    const handleFurnitureRemove = (event) => {
        ...
        axios.post(`${process.env.REACT_APP_URI}/user/wishlist/furniture/${id}/delete`, {
        }, axiosConfig)
            .then(async (res) => {
                console.log("removed from wishlist");
                setIsDeleted(true);
    ...
    const handleHandicraftRemove = (event) => {
        ...
        axios.post(`${process.env.REACT_APP_URI}/user/wishlist/handicrafts/${id}/delete`, {
        }, axiosConfig)
            .then(async (res) => {
                console.log("removed from wishlist");
                setIsDeleted(true);
    ...
    const handleOtherRemove = (event) => {
        ...
        axios.post(`${process.env.REACT_APP_URI}/user/wishlist/others/${id}/delete`, {
        }, axiosConfig)
            .then(async (res) => {
                console.log("removed from wishlist");
                setIsDeleted(true);
